...
function skill.CommonDamage(e, is_my_damage, rank)
	...
	enemy:SetHate(ally, enemy:GetHateAmount(ally, false)+damage)
	ally:HealDamage(damage / 2)
	builds.Debug(ally, string.format("Ironclad Challenge dealt %d points of damage to %s and added double hate.", damage, enemy:GetCleanName()))
	return e
end
