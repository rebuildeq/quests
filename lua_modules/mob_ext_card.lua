...
local tags = {
	...
	{ID = 148147, Name = "Fish", Chance = 500, Check = function(self) return (self:GetBaseRace() == race_name.Fish or self:GetBaseRace() == race_name.Shark or self:GetBaseRace() == race_name.Piranha or self:GetBaseRace() == race_name.Swordfish or self:GetBaseRace() == race_name.KunarkFish or self:GetBaseRace() == race_name.Mermaid or self:GetBaseRace() == race_name.SeaHorse or self:GetBaseRace() == race_name.SeaTurtle or self:GetBaseRace() == race_name.PhinigelAutropos) end},
}
