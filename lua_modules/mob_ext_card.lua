...
---@ type RaceEntry[]
local tags = {
	{ID = 148101, Name = "Dragon", Chance = 500, Check = function(self) return (self:GetBaseRace() == 195 or self:GetBaseRace() == 19 or self:GetBaseRace() == 49 or self:GetNPCTypeID() == 96073 or self:GetBaseRace() == 184 or self:GetNPCTypeID() == 96089) end},
	...
	{ID = 148104, Name = "Construct", Chance = 500, Check = function(self) return self:GetBodyType() == BT.Construct end},
	...
	{ID = 148114, Name = "Gnoll", Chance = 500, Check = function(self) return self:GetBaseRace() == race.Gnoll end},
	{ID = 148115, Name = "Aviak", Chance = 500, Check = function(self) return self:GetBaseRace() == race.Aviak end},
	...
	{ID = 148122, Name = "Human", Chance = 500, Check = function(self) return (self:GetBaseRace() == race.Human or self:GetBaseRace() == 44 or self:GetBaseRace() == 71) end},
	{ID = 148123, Name = "Barbarian", Chance = 500, Check = function(self) return self:GetBaseRace() == race.Barbarian end},
	{ID = 148124, Name = "Erudite", Chance = 500, Check = function(self) return self:GetBaseRace() == race.Erudite end},
	{ID = 148125, Name = "Wood Elf", Chance = 500, Check = function(self) return self:GetBaseRace() == race.WoodElf end},
	{ID = 148126, Name = "High Elf", Chance = 500, Check = function(self) return self:GetBaseRace() == race.HighElf end},
	{ID = 148127, Name = "Dark Elf", Chance = 500, Check = function(self) return self:GetBaseRace() == race.DarkElf end},
	{ID = 148128, Name = "Half Elf", Chance = 500, Check = function(self) return self:GetBaseRace() == race.HalfElf end},
	{ID = 148129, Name = "Dwarf", Chance = 500, Check = function(self) return self:GetBaseRace() == race.Dwarf end},
	{ID = 148130, Name = "Troll", Chance = 500, Check = function(self) return self:GetBaseRace() == race.Troll end},
	{ID = 148131, Name = "Ogre", Chance = 500, Check = function(self) return self:GetBaseRace() == race.Ogre end},
	{ID = 148132, Name = "Halfling", Chance = 500, Check = function(self) return self:GetBaseRace() == race.Halfling end},
	{ID = 148133, Name = "Gnome", Chance = 500, Check = function(self) return self:GetBaseRace() == race.Gnome end},
	{ID = 148134, Name = "Froglok", Chance = 500, Check = function(self) return (self:GetBaseRace() == race.Froglok or self:GetBaseRace() == 26 or self:GetBaseRace() == 27 ) end},
	{ID = 148135, Name = "Shadowed Man", Chance = 500, Check = function(self) return (self:GetBaseRace() == race.Invisible_Man or self:GetBaseRace() == race.Dervish or self:GetBaseRace() == 431) end},
